...
namespace SharpMatter.SharpMath
{
    ...
    public static class SharpMath
    {
        ...
        /// </summary>
        /// <param name="minSourceDomain">
        /// Source domain min
        /// </param>
        /// <param name="maxSourceDomain">
        /// Source domain max
        /// </param>
        /// <param name="minTargetDomain">
        /// Target domain min
        /// </param>
        /// <param name="maxTargetDomain">
        /// Target domain max
        /// </param>
        /// <param name="valueToRemap">
        /// value to remap
        /// </param>
        /// <returns></returns>
        public static double Remap(
            double minSourceDomain,
            double maxSourceDomain,
            double minTargetDomain,
            double maxTargetDomain,
            double valueToRemap)
        {
            return minTargetDomain + (maxTargetDomain - minTargetDomain) *
                ((valueToRemap - minSourceDomain) / (maxSourceDomain - minSourceDomain));
        }
        ...
        public static List<double> Range(double numberOfSteps)
        {
            ...
            for (int i = 0; i < numberOfSteps; i++) values.Add(count += steps);
